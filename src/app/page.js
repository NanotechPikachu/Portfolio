export default function Home() {
  return (
    <>
    <div className="ml-8 mr-8 mt-24 mb-20 dark:bg-grey-950 bg-slate-50">
    ...
    <div className="mt-6 mr-4 ml-4 border dark:border-emerald-600 border-emerald-400 dark:bg-grey-900 bg-slate-100">
